...
export const players: Player[] = [
  ...
  },
  {
    ...
    age: 33,
    rating: 89,
    attributes: { pace: 86, shooting: 86, passing: 84, dribbling: 93, defending: 33, physical: 63 },
    recentForm: [8.1, 8.4, 7.9, 8.7, 8.0, 8.6, 8.3],
    strengths: ["Dribbling", "1v1 Play", "Chance Creation", "Flair"],
    growthAreas: ["Defensive Work", "Availability"],
    playstyle: "Creative attacker who destabilizes defenders with flair, touch, and acceleration.",
    summary: "Neymar still changes games through imagination, close control, and final-third invention.",
    pressureRating: 88,
  },
  {
    id: "P101",
